...
public class GetContestsThatIntersectRecord extends TableRecordImpl<GetContestsThatIntersectRecord> implements Record5<Integer, Duration, String, Boolean, Timestamp>, IGetContestsThatIntersect {
	 ...
	 */
	@Override
	public GetContestsThatIntersectRecord values(Integer value1, Duration value2, String value3, Boolean value4, Timestamp value5) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public GetContestsThatIntersectRecord(Integer id, Duration duration, String name, Boolean showFullTestsDuringContest, Timestamp startTime) {
		super(GetContestsThatIntersect.GET_CONTESTS_THAT_INTERSECT);
